...
default_state = json.loads('{"bar2":{"styles":{"width":"","height":"","minWidth":"","minHeight":"","maxWidth":"","maxHeight":"","overflow":""},"custom":{"cartesianGrid":{"show":false,"strokeDasharray":""},"data":[],"xAxis":{"show":false,"key":""},"yAxis":{"show":false},"toolTip":{"show":false},"legend":{"show":false},"stacked":false,"options":{}}}}')
...
class Atri:
	...
	@property
	def bar2(self):
		self._getter_access_tracker["bar2"] = {}
		return self._bar2
	@bar2.setter
	def bar2(self, new_state):
		self._setter_access_tracker["bar2"] = {}
		global default_state
		self._bar2 = BarChart(new_state, default_state["bar2"])
